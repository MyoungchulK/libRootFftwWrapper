   ...
   */
   class SineFitterLimits
   {
     public: 
       ...
       SineFitterLimits(double maxA_relative_to_guess_ = 1.5, double minA_relative_to_guess_ = 0.00001, 
   ...
   **/ 
    ...
    class SineSubtract 
    {
      ...
      private: 
        ...
        //! baseline
        std::vector<std::vector<double>> baseline_fft;
        //const TGraph * baseline;
